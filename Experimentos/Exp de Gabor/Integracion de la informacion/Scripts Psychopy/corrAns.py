...
expName = 'corrAns'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Antonella\\Desktop\\Doctorado\\Exp de Gabor\\Scripts Psychopy\\corrAns.py',
...
for thisTrial in trials:
    ...
    key_resp.rt = []
    _key_resp_allKeys = []
    text.setText("The correct answer is " + str(corrAns) + "\nPress SPACE for incorrect response")
