...
expName = 'gausiianmakstrial'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Antonella\\Experimentos\\Exp de Gabor\\Integracion de la informacion\\gausiianmakstrial_lastrun.py',
...
grating = visual.GratingStim(
    ...
    opacity=1.0, contrast=0.9, blendmode='avg',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    mask_size=(250,250)
    mask_grating.size = mask_size  # Update the Gaussian mask size based on the "mask_size" variable
      # Update the main grating texture with the mask texture
