...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\UdeSA\\Desktop\\Antonella\\Doctorado (1)\\Exp de Gabor\\Exp de Gabor\\Scripts Psychopy\\PruebaGabor2.py',
...
grating2 = visual.GratingStim(
    win=win, name='grating2',units='deg', 
    tex='sin', mask='circle', anchor='center',
    ori=1.0, pos=(0,0), size=(200, 200), sf=1.0, phase=0,
    color=[1,1,1], colorSpace='rgb',
    opacity=1, contrast=1.0, blendmode='avg',
...
Training = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('ParametrosAyBTest1.xlsx'),
